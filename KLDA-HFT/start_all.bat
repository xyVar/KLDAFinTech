...
echo [5/6] Starting Trading Engine (signal executor)...
start "KLDA Engine" /MIN cmd /c "cd C:\Users\PC\Desktop\KLDAFinTech\KLDA-HFT\trading-engine && python klda_engine.py"
